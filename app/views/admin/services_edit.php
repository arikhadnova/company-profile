...
<form action="<?= BASE_URL; ?>admin/services_update" method="POST">
                ...
                <div class="card-body p-4">
                    <div class="mb-4">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" name="icon" class="form-control border-start-0 ps-0" value="<?= $service->icon; ?>" id="iconInput" required>
                        </div>
                        <div class="d-flex align-items-center gap-3 mt-3">
                            <div id="iconPreview" class="stat-icon-box stat-icon-blue" style="width: 50px; height: 50px;">
                                <i class="<?= $service->icon ?: 'fas fa-question text-muted'; ?>"></i>
                            </div>
