            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="small_subtitle_id" class="form-control" placeholder="Contoh: Capacity Building">
                        <input type="hidden" name="small_subtitle_en" value="">
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="outputs_id" class="form-control" placeholder="Contoh: Modul, Sertifikat, Dokumentasi">
                        <input type="hidden" name="outputs_en" value="">
                    </div>
                    <div class="mb-0">
                        <label class="form-label fw-bold small text-dark">Konten Detail</label>
                        <textarea name="detail_content_id" class="form-control rich-editor" rows="15" placeholder="Konten lengkap untuk halaman detail..."></textarea>
